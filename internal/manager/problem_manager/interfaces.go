...
type ProblemManager interface {
	...
	CreateProblemTaskTemplate(ctx context.Context, dto domain.TaskTemplateCreateInput) (domain.Problem, error)
	...
	CreateProblemTestCase(ctx context.Context, dto domain.TestCaseCreateInput) (domain.Problem, error)
